...
derive instance Generic (GSum a b) _
...
instance FunnyEncode Int where encodeFunny = show 
instance FunnyEncode String where encodeFunny = identity
instance FunnyEncode Char where encodeFunny = String.singleton
instance FunnyEncode Boolean where encodeFunny = show 
instance FunnyEncode a => FunnyEncode (Maybe a) 
  where encodeFunny = genericEncodeFunny
instance (FunnyEncode a, FunnyEncode b) => FunnyEncode (Tuple a b) 
  where encodeFunny = genericEncodeFunny
